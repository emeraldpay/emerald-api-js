...
----
pnpm --filter @emeraldpay/api run build
pnpm --filter @emeraldpay/api-node run build
pnpm --filter @emeraldpay/api-web run build
----

.Compile individual modules
----
pnpm --filter @emeraldpay/api run build:ts
pnpm --filter @emeraldpay/api-node run build:ts
pnpm --filter @emeraldpay/api-web run build:ts
----

.Test individual modules
----
pnpm --filter @emeraldpay/api run test
pnpm --filter @emeraldpay/api-node run test
pnpm --filter @emeraldpay/api-web run test
----
